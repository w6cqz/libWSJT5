...
C     Peak up in frequency and time, and compute ftrack.
      ...
      nfft=2048   !Size of FFTs
      dt=2.0/11025.0
      df=0.5*11025.0/nfft
      call zero(ps,77)
      k=istart-nfft

C     NB: this could be done starting with array c3, in ftpeak65,
C     instead of the dat() array.  Would save some time this way ...
